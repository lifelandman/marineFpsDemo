###########################################################
###                                                     ###
### Panda3D Configuration File -  Experiment Version    ###
###                                                     ###
###########################################################

#This is copied from Hatcher's version of the config file.
#It's largely the same as the default panda3d config-
#-with some exceptions, notably the default file-loading locations.
#since the only files hatcher should load without a selection dialog-
#-are used for ui images and whatnot.
